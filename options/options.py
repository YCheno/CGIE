...
def parse(opt_path, is_train=True):
    ...
    if is_train:
        ...
        # opt['path']['val_images_lbp'] = os.path.join(experiments_root, 'val_images_lbp')
        # opt['path']['val_images_GTlbp'] = os.path.join(experiments_root, 'val_images_GTlbp')
        # opt['path']['val_images_SRlbp'] = os.path.join(experiments_root, 'val_images_SRlbp')
